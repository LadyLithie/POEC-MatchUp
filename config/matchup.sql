...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 19 Septembre 2017 à 07:14
...
--
-- Contenu de la table `candidate_skill`
--
...
--
ALTER TABLE `enterprise`
  MODIFY `id_enterprise` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
...
--
ALTER TABLE `skill`
  MODIFY `id_skill` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
