...
public class PanelAdministrator extends BaseView {
	...
	public PanelAdministrator(JFrame frame) {
		...
		btnEdider = new JButton("Editer");
		btnEdider.setVisible(true);
		GridBagConstraints gbc_btnValider = new GridBagConstraints();
		gbc_btnValider.insets = new Insets(0, 0, 0, 5);
		gbc_btnValider.gridx = 2;
		gbc_btnValider.gridy = 4;
		panelAdminPresentation.add(btnEdider, gbc_btnValider);
		...
		GridBagLayout gbl_listSkills = new GridBagLayout();
		gbl_listSkills.columnWidths = new int[]{0, 0, 0, 0};
		gbl_listSkills.rowHeights = new int[]{0, 0};
		gbl_listSkills.columnWeights = new double[]{1.0, 1.0, 1.0, Double.MIN_VALUE};
		gbl_listSkills.rowWeights = new double[]{0.0, Double.MIN_VALUE};
		listSkills.setLayout(gbl_listSkills);
